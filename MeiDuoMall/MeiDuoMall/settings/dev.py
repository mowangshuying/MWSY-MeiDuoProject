...
SECRET_KEY = 'pab!8(l4*h$wkx*#v))1^z&^1%fe@o$gd0#oh4(bv(2rg4t%zu'
...
# 数据库配置：https://docs.djangoproject.com/en/1.11/ref/settings/#databases
DATABASES = {
    'default': {
...
EMAIL_PORT = 25 # 发邮件端口
EMAIL_HOST_USER = 'mowangshuying@163.com' # 授权的邮箱
EMAIL_HOST_PASSWORD = 'KBNNVPKZCMJGHMEP' # 邮箱授权时获得的密码，非注册登录密码
EMAIL_FROM = '美多商城<mowangshuying@163.com>' # 发件人抬头